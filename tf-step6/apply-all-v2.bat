...
if not defined APP_NAMESPACE set "APP_NAMESPACE=de-ai-13"
if not defined IMAGE_TAG set "IMAGE_TAG=k8s-auto"

set "SECRET_JSON_FILE=%TEMP%\de-ai-13-rds-secret-%RANDOM%.json"
set "DB_ENV_FILE=%TEMP%\de-ai-13-rds-env-%RANDOM%.txt"
