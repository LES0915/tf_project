...
# EIP의 퍼블릭 IP 출력
# output "public_ip" {
#     value = aws_eip.DE-AI-13-IaC-TF-EIP.public_ip
...
output "instance_id" {
    ...
    # TODO: count에 따라 출력방식 변경
    value = [
        # aws_instance.DE-AI-13-IaC-TF 하나씩 꺼내서 (instance.id) instance 담는다
        for instance in aws_instance.DE-AI-13-IaC-TF : instance.id
    ]
}